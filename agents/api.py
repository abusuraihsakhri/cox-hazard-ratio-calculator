"""
FastAPI REST API Server for Cox Hazard Ratio Calculator.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "cox-hazard-ratio-calculator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
