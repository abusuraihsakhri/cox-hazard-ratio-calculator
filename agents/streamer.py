"""
Live WebSocket Distributed Component Telemetry Streamer for cox-hazard-ratio-calculator.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "cox-hazard-ratio-calculator", "event_type": event_type, "payload": data})
