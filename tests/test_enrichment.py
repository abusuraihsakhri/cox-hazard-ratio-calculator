"""
Automated Pytest for cox-hazard-ratio-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    MultivariableCoxWithInteractionTermsEngine,
    ProportionalHazardsVerificationSuiteEngine,
    StratifiedCoxCoxWithStrataEngine,
    ConcordanceIndexHarrellsCEngine,
    BrierScoreCalibrationEngine,
    CoxLassoPenalizedRegressionEngine,
    CoxhazardratiocalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = CoxhazardratiocalculatorEnrichmentSuite()
